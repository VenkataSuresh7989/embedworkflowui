    ...
    return {
      tooldata: {
        "MSAM Keys": [
          ...
          { label: "dev_eui", value: "Device Extended Unique Identifier", isCopy : false },
          { label: "app_key", value: "Application Key (For FUOTA)", isCopy : false },
          { label: "join_eui", value: "Join Extended Unique Identifier", isCopy : false },
          { label: "nwk_key", value: "Network Key (For Join Request & Response)", isCopy : false }
        ],
        "Module ID": [
        ...
        "VPN Configuration": [
          { label: "Portal", value: "ctec-vpn-test.charterlab.com", isCopy : true },
          { label: "Username", value: "P3318271", isCopy : true },
          { label: "Password", value: "NR@msam_2025", isCopy : true }
        ],
        
        "AWS Join & FUOTA Server URL(s)": [
          { label: "Join Server API", value: "https://joinserver.embedtechnologies.com/joinreq", isCopy : true },
          { label: "FUOTA Server API", value: "https://joinserver.embedtechnologies.com/v1/mcrootkey", isCopy : true }
        ],
        "Charter Join & FUOTA Server URL(s)": [
          { label: "Join Server API", value: "https://joinserver.caas.charterlab.com:443", isCopy : true },
          { label: "FUOTA Server API", value: "https://joinserver.caas.charterlab.com/v1/mcrootkey", isCopy : true }
        ],
